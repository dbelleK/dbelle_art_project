...
.TermsModal__navigatorItem:hover{
    border-bottom-color: #38c5a4;
    color: #1dd5a2;
    font-weight: 500;
} 
	...
	<div class="Modal__root" role="button" tabindex="0">
		<div class="TermsModal">
			...
			<div class="TermsModal__navigator">
				<button class="TermsModal__navigatorItem--selected" type="button" id="pr" >개인정보 처리방침</button>
				<div class="TermsModal__dot"></div>
				<button class="TermsModal__navigatorItem" type="button" id="st">스토어 이용약관</button>
				<div class="TermsModal__dot"></div>
				<button class="TermsModal__navigatorItem " id="mk" type="button">마케팅 수신 및 개인정보 활용</button>
			</div>
			
			<!-- privacy  -->
			<div class="TermsModal__contentBox privacy first">
				<div class="TermsModal__content">
					<h1>코드잇 개인정보 처리방침</h1>
					<p>㈜코드잇(이하 "회사")는 이용자의 동의를 기반으로 개인정보를 수집·이용 및 제공하고 있으며 이용자의 권리를
					...
					<table>
						...
						<tbody>
							<tr>
								<td>Codeit 회원가입 및 회원 ID의 제공 (필수), 본인여부 확인 및 본인 인증</td>
					...
					<p>기업회원이 소속 직원으로 하여금 코드잇의 강의를 수강하게 하는 경우, 코드잇은 소속 직원의 동의를 받고 그
					...
					<ul>
						...
						<li>
							<p>
								전화/이메일: <a href="mailto:dev@codeit.com">dev@codeit.com</a>
							</p>
						</li>
					</ul>
			...
			<div class="TermsModal__contentBox store">
				<div class="TermsModal__content">
					...
					<p>환영합니다.</p>
					<p>Codeit이 제공하는 서비스를 이용해주셔서 감사합니다. 서비스를 이용하시거나 회원으로 가입하실 경우 본
						약관에 동의하시게 되므로, 잠시 시간을 내셔서 주의 깊게 살펴봐 주시기 바랍니다.</p>
					<h2>제 1 조 (목적)</h2>
					<p>본 약관은 ㈜코드잇이 운영하는 기밀문서 관리 프로그램인 Codeit에서 제공하는 서비스를 이용함에 있어
					...
					<ol>
						<li>
							...
							<ol>
								<li>“서비스"란 맞춤형 온라인 코딩 교육 프로그램을 제공하는 Codeit의 제반 서비스를 말합니다.
									(URL : <a href="https://www.codeit.kr/">https://www.codeit.kr</a>
									또는 <a href="https://www.codeit.com/">https://www.codeit.com</a>
									)
								</li>
								<li>회사란 Codeit을 운영하는 ㈜코드잇을 말합니다.</li>
								<li>이용자란 Codeit에 접속하여 본 약관에 따라 Codeit이 제공하는 서비스를 받는 회원 및
									비회원을 말합니다.</li>
								<li>"회원"이라 함은 Codeit에 회원등록을 한 자로서, 계속적으로 Codeit이 제공하는 서비스를
									이용할 수 있는 자를 말합니다.</li>
								<li>"비회원"이라 함은 회원에 가입하지 않고 Codeit이 제공하는 제한된 서비스를 이용하는 자를
									말합니다.</li>
					...
					<ol>
						<li>
							<p>
								Codeit은 본 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소, 전화번호, 전자우편주소,
								사업자등록증번호, 통신판매업 신고번호, 개인정보관리책임자 등을 이용자가 쉽게 알 수 있도록 Codeit의 사이트(<a
									href="https://codeit.com/">https://codeit.com</a>, <a
									href="https://codeit.kr/)%EC%97%90">https://codeit.kr/)에</a>
								게시하고 있습니다.
							</p>
						</li>
						<li>
							<p>Codeit은 「전자상거래 등에서의 소비자보호에 관한 법률」, 「약관의 규제에 관한 법률」, 「전자문서
								및 전자거래기본법」, 「전자금융거래법」, 「전자서명법」, 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」,
								「방문판매 등에 관한 법률」, 「소비자기본법」 등 관련 법을 위배하지 않는 범위에서 본 약관을 개정할 수 있습니다.</p>
						</li>
						<li>
							<p>회사는 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 Codeit의 초기화면에
								그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다. 다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는
								최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 Codeit은 개정 전 내용과 개정 후 내용을
								명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.</p>
						</li>
						<li>
							<p>전항에 따른 개정 약관 중 변경 또는 개정한 내용이 고객에게 불리한 경우에는 회원은 언제든지 본 계약의
								해지 및 회원탈퇴를 할 수 있으며, 이 경우 Codeit은 회원에게 불이익이 없도록 조치를 취해야 합니다.</p>
						</li>
						<li>
					...
					<ol>
						...
						<li>
							<p>Codeit은 서비스의 기술적 사양의 변경 등의 경우에는 변경된 서비스의 내용 및 제공일자를 명시하여
								현재의 서비스의 내용을 게시한 곳에 즉시 공지합니다.</p>
						</li>
						<li>
							<p>Codeit이 제공하기로 이용자와 계약을 체결한 서비스의 내용을 기술적 사양의 변경, 정책 변경 등의
					...
					<ol>
						<li>
							<p>회사는 Codeit에서 제공하는 서비스의 품질을 향상시키기 위하여 설비의 보수, 교체, 정기점검, 공사
					...
					<ol>
						<li>
							<p>이용계약은 회원이 되고자 하는 자가 이 약관의 내용에 대하여 동의를 한 다음 Codeit이 정한 가입
						...
						<li>
							<p>Codeit은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각 호에 해당하지 않는 한
								회원으로 등록합니다.</p>
							<ol>
						...
						<li>
							<p>회원은 회원가입 시 등록한 사항에 변경이 있는 경우, 상당한 기간 이내에 Codeit에 대하여 회원정보
					...
					<ol>
						<li>
							<p>Codeit이 회원에 대한 통지를 하는 경우, 회원이 회원가입시 Codeit에게 제공한 전자우편 또는
					...
					<ol>
						...
						<li>
							...
							<ol>
								...
								<li>Codeit을 이용하여 구입한 멤버십 서비스 등의 대금, 기타 회원이 부담하는 채무를 기일에
									지급하지 않는 경우</li>
								<li>다른 사람의 Codeit 이용을 방해하거나 그 정보를 도용하는 등 서비스 이용과 관련된 질서를
									위협하는 경우</li>
						...
						<li>
							<p>Codeit이 회원 자격을 제한․정지시킨 후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그
								사유가 시정되지 아니하는 경우 Codeit은 회원자격을 상실시킬 수 있습니다.</p>
						</li>
						<li>
							<p>Codeit이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를 통지하고,
					...
					<ol>
						<li>
							<p>회원은 Codeit 사이트에서 회사가 제공하는 서비스에 대한 멤버십을 신청할 수 있습니다. 유료 서비스인
						...
						<li>
							...
							<ol>
								...
								<li>기타 멤버십 신청을 승낙하는 것이 Codeit 기술상 또는 정책상 현저히 지장이 있다고 판단하는
									경우</li>
								<li>경쟁업체 또는 그 관련인이 신청한 경우</li>
							</ol>
						</li>
						<li>
							<p>Codeit 이용계약은 제1항의 결제가 완료된 후 회사가 이를 확인하여 서비스 이용 승낙에 대한
								의사표시를 웹사이트를 통해 알림으로서 성립한 것으로 봅니다.</p>
						</li>
						<li>
							<p>Codeit은 이용자와 서비스 제공 개시일에 관하여 별도의 약정이 없는 이상, 이용자가 멤버십 결제를 한
								날부터 Codeit 서비스를 이용할 수 있도록 필요한 조치를 취합니다.</p>
						</li>
						<li>
							<p>멤버십 결제를 한 이용자는 의사표시의 불일치 등이 있는 경우에는 결제한 즉시 구매신청 변경 및 취소를
								요청할 수 있고 Codeit은 이용자의 요청이 있는 경우에는 지체 없이 그 요청에 따라 처리하여야 합니다. 다만
								이미 대금을 지불한 경우에는 Codeit의 환불 기준(세부지침 홈페이지 내 별도 게시)에 관한 규정에 따릅니다.</p>
						</li>
					</ol>
					<h2>제 11 조 (개인정보보호)</h2>
					<ol>
						...
						<li>
							<p>이용자는 언제든지 Codeit이 가지고 있는 자신의 개인정보에 대해 열람 및 오류정정을 요구할 수 있으며
								Codeit은 이에 대해 지체 없이 필요한 조치를 취할 의무를 집니다. 이용자가 오류의 정정을 요구한 경우에는
								Codeit은 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다. 단, 이용자의 개인정보가 Codeit
					...
					<ol>
						<li>
							<p>회사는 Codeit의 운영과 관련하여 법령과 본 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며
								본 약관이 정하는 바에 따라 지속적이고, 안정적인 서비스를 제공하는데 최선을 다하여야 합니다.</p>
						</li>
						<li>
							<p>회사는 이용자가 안전하게 Codeit 서비스를 이용할 수 있도록 이용자의 개인정보(신용정보 포함)보호를
						...
						<li>
							...
							<ol>
								...
								<li>다량의 정보를 전송하거나, 동일한 또는 유사한 내용의 정보를 반복적으로 게시하여 서비스의 안정적인
									운영을 방해하는 행위</li>
								<li>Codeit의 서비스를 이용하여 얻은 정보를 Codeit의 사전 승낙 없이 복제 또는 유통시키거나
					...
					<ol>
						...
						<li>
							<p>회원이 자신의 ID 및 비밀번호를 도난 당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로
								Codeit에 통보하고 Codeit의 안내가 있는 경우에는 그에 따라야 합니다.</p>
						</li>
					</ol>
					...
					<ol>
						...
						<li>
							<p>이용자는 Codeit을 이용함으로써 얻은 정보 중 Codeit에게 지적재산권이 귀속된 정보를
								Codeit의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나
								제3자에게 이용하게 하여서는 안됩니다.</p>
						</li>
						<li>
							<p>이용자는 Codeit이 이용자에게 귀속된 저작물(예, 과제물)을 Codeit의 서비스 개선, 포트폴리오
								및 홍보 등의 목적으로 사용할 수 있는 권한을 Codeit에 부여합니다.</p>
						</li>
					</ol>
					...
					<p>이용자는 Codeit에서 생성한 아이디 및 비밀번호, 계정 등을 회사의 사전 서면 동의 없이 제3자에게
					...
					<ol>
						...
						<li>
							<p>이용자는 코드잇의 사전 서면 동의 없이 서비스를 이용하여 영리적인 목적의 영업행위를 하여서는 안 됩니다.
			...
			<!-- marketing  -->
			<div class="TermsModal__contentBox marketing">
				<div class="TermsModal__content">
